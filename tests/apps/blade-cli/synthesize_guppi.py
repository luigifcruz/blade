...
parser.add_argument("-a", type=int, help="Number of antenna.", default=27)
parser.add_argument("-c", type=int, help="Number of channels per antenna.", default=32)
parser.add_argument("-t", type=int, help="Number of time-samples.", default=131072)
...
parser.add_argument("-B", type=int, help="Blocks per file.", default=10485760//131072)
...
delays = np.array([0 for i in range(n_ant)])  # as samples
...
rvb.record(
    ...
    header_dict={
        ...
        "RA_OFF0": 3.5,
        "DEC_OFF0": 36.0,
        "ANTNMS00": "ea01a,ea02a,ea03a,ea04a,ea05a,ea06a,ea07a,ea08a,ea09a,ea10a,ea11a",
        "ANTNMS01": "ea28a,ea13a,ea14a,ea15a,ea16a,ea17a,ea18a,ea19a,ea20a,ea21a,ea22a",
        "ANTNMS02": "ea23a,ea24a,ea25a,ea26a,ea27a",
    },
    verbose=False,
    load_template=False,
)
